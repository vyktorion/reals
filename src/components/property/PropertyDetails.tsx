            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 p-8">
              ...
              <div className="sticky top-8 h-fit">
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  {(property.virtualTour || true) && (  // Mocking virtual tour for now
              ...
              <div className="overflow-y-auto max-h-[calc(100vh-8rem)]">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-4 gap-4">
                        ...
                        <div className="bg-background rounded-xl p-4">
                          ...
                          <div className="text-gray-900">{property.parking || 0}</div>
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                        {[
                          ...
                          { label: 'Year Built', value: property.yearBuilt ? property.yearBuilt.toString() : 'N/A' },
                          { label: 'Area', value: `${property.area.toLocaleString('en-US')} ${property.areaUnit || 'sqft'}` },
                          { label: 'Lot Size', value: property.lotSize ? `${property.lotSize.toLocaleString('en-US')} ${property.lotSizeUnit || 'sqft'}` : 'N/A' },
                          { label: 'Parking', value: `${property.parking || 0} spaces` },
                          { label: 'Pet Policy', value: property.petPolicy === 'allowed' ? 'Pet Friendly' : property.petPolicy === 'conditional' ? 'Conditional' : property.petPolicy === 'not_allowed' ? 'No Pets' : 'Not Specified' },
                        ].map((item, index) => (
                        ...
                        <div className="py-3 border-b border-gray-100">
                          ...
                          <div className="text-gray-900">{property.createdAt ? new Date(property.createdAt).toLocaleDateString() : 'N/A'}</div>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="mt-8 bg-linear-to-br from-blue-50 to-gray-50 rounded-2xl p-6">
                  ...
                  <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                    <ImageWithFallback
                      src={property.agent?.avatar || '/placeholder-avatar.jpg'}
                      alt={property.agent?.name || 'Agent'}
                      className="w-16 h-16 rounded-full object-cover ring-4 ring-white shadow-md"
                    />
                    <div className="flex-1">
                      <div className="text-gray-900 mb-1">{property.agent?.name || 'Agent'}</div>
              ...
              <div className="p-6 pb-32">
                ...
                <div className="grid grid-cols-4 gap-3 mb-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-gray-900 text-sm">{property.parking || 0}</div>
                    <div className="text-xs text-gray-600">Parking</div>
                  </div>
                </div>
                ...
                <div className="bg-linear-to-br from-blue-50 to-gray-50 rounded-2xl p-4">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    />
                    <div>
                      <div className="text-gray-900">{property.agent?.name || 'Agent'}</div>
