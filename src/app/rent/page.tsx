...
// Search page specifically for properties for rent
...
export default function RentPage() {
  ...
  // Mock properties data for rent
  const properties: Property[] = [
    {
      id: '2',
      title: 'Cozy Studio Apartment',
      description: 'Perfect studio for students in the heart of the city',
      price: 2500,
      type: 'rent',
      status: 'active',
      location: {
      ...
      amenities: ['WiFi', 'Laundry', 'Air Conditioning', 'Fitness Center'],
      features: ['Student Housing', 'Short-term'],
      furnished: false,
      featured: false,
      userId: 'user-2',
      views: 145,
    ...
    },
    {
      ...
      yearBuilt: 2021,
      images: ['/placeholder-property.jpg'],
      amenities: ['Balcony', 'Gym', 'Pool', 'Concierge', 'Parking'],
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Find your perfect rental home from our curated collection of properties</p>
      </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <span className="text-sm text-gray-600">
            {filteredProperties.length} properties for rent found
          </span>
      ...
      {filteredProperties.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No properties for rent found</h3>
